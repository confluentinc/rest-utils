 ...
 * matters because {@link DualTrustManager} does not cryptographically validate non-SPIFFE
 * ("legacy") client certificates: their presence alone must never be used to grant
